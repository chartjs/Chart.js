...
1))}},function(d){var g=-Math.PI/2,w=2*Math.PI/a.length,k=1,f=1;c.animation&&(c.animateScale&&(k=d),c.animateRotate&&(f=d));for(var e=0;e<a.length;e++){b.beginPath();b.arc(n/2,u/2,k*y(a[e].value,h,l),g,g+f*w,!1);b.lineTo(n/2,u/2);b.closePath();b.fillStyle=a[e].color;b.fill();if(0.9999999<d){var x=[{x:n/2,y:u/2}],H=y(a[e].value,h,l);x.push({x:n/2+H*Math.cos(g),y:u/2+H*Math.sin(g)});for(var I=0;50>=I;I++)x.push({x:n/2+H*Math.cos(g+I/50*f*w),y:u/2+H*Math.sin(g+I/50*f*w)});A(b,{type:"shape",points:x},
...
e,-k)}b.restore()},function(d){var g=2*Math.PI/a.datasets[0].data.length;b.save();b.translate(n/2,u/2);for(var f=0;f<a.datasets.length;f++){var k=y(a.datasets[f].data[0],h,l);b.beginPath();b.moveTo(0,d*-1*k);if(1==d){var e=n/2+k*Math.cos(0-Math.PI/2),k=u/2+k*Math.sin(0-Math.PI/2),r=c.pointDot?c.pointDotRadius+c.pointDotStrokeWidth:10;a.labels[0].trim();A(b,{type:"circle",x:e,y:k,r:r},{label:a.labels[0],value:a.datasets[f].data[0]},"Radar")}for(var x=1;x<a.datasets[f].data.length;x++)k=y(a.datasets[f].data[x],
h,l),b.rotate(g),b.lineTo(0,d*-1*k),1==d&&(e=n/2+k*Math.cos(x*g-Math.PI/2),k=u/2+k*Math.sin(x*g-Math.PI/2),r=c.pointDot?c.pointDotRadius+c.pointDotStrokeWidth:10,a.labels[x].trim(),A(b,{type:"circle",x:e,y:k,r:r},{label:a.labels[x],value:a.datasets[f].data[x]},"Radar"));b.closePath();b.fillStyle=a.datasets[f].fillColor;b.strokeStyle=a.datasets[f].strokeColor;b.lineWidth=c.datasetStrokeWidth;b.fill();b.stroke();if(c.pointDot){b.fillStyle=a.datasets[f].pointColor;b.strokeStyle=a.datasets[f].pointStrokeColor;
b.lineWidth=c.pointDotStrokeWidth;for(e=0;e<a.datasets[f].data.length;e++)b.rotate(g),b.beginPath(),b.arc(0,d*-1*y(a.datasets[f].data[e],h,l),c.pointDotRadius,2*Math.PI,!1),b.fill(),b.stroke()}b.rotate(g)}b.restore()},b)},Q=function(a,c,b){for(var d=0,l=Math.min.apply(Math,[u/2,n/2])-5,h=0;h<a.length;h++)d+=a[h].value;b.fillStyle="black";b.textBaseline="base";B(c,null,function(h){var f=-Math.PI/2,e=1,m=1;c.animation&&(c.animateScale&&(e=h),c.animateRotate&&(m=h));for(var p=0;p<a.length;p++){var g=
m*a[p].value/d*2*Math.PI;b.beginPath();b.arc(n/2,u/2,e*l,f,f+g);b.lineTo(n/2,u/2);b.closePath();b.fillStyle=a[p].color;b.fill();if(a[p].label&&2*(e*l)*g/(2*Math.PI)>c.labelFontSize){var w=function(a){switch(a){case "left":return"right";case "right":return"left";case "center":return a}},k=a[p].labelFontSize||c.labelFontSize+"px";null!=k.match(/^[0-9]+$/g)&&(k+="px");b.font=c.labelFontStyle+" "+k+" "+c.labelFontFamily;b.fillStyle=N(h,a[p].labelColor||"black",a[p].color);b.textBaseline="middle";var k=
-(f+g)+g/2,q=n/2+e*l*Math.cos(k),t=u/2-e*l*Math.sin(k);b.textAlign=a[p].labelAlign||c.labelAlign;textX=function(a,b){switch(a){case "left":return-b+20;case "center":return-b/2}return-10}(b.textAlign,e*l);k<-Math.PI/2&&(k-=Math.PI,b.textAlign=w(b.textAlign),textX=-textX);b.translate(q,t);b.rotate(-k);b.fillText(a[p].label,textX,0);b.rotate(k);b.translate(-q,-t)}if(0.9999999<h){w=[{x:n/2,y:u/2}];w.push({x:n/2+l*Math.cos(f),y:u/2+l*Math.sin(f)});for(k=0;50>=k;k++)w.push({x:n/2+l*Math.cos(f+k/50*g),y:u/
2+l*Math.sin(f+k/50*g)});A(b,{type:"shape",points:w},{label:a[p].label,value:a[p].value},"Pie")}c.segmentShowStroke&&(b.lineWidth=c.segmentStrokeWidth,b.strokeStyle=c.segmentStrokeColor,b.stroke());f+=g}},b)},R=function(a,c,b){for(var d=0,l=Math.min.apply(Math,[u/2,n/2])-5,h=l*(c.percentageInnerCutout/100),m=0;m<a.length;m++)d+=a[m].value;B(c,null,function(f){var e=-Math.PI/2,m=1,p=1;c.animation&&(c.animateScale&&(m=f),c.animateRotate&&(p=f));for(var g=0;g<a.length;g++){var r=p*a[g].value/d*2*Math.PI;
b.beginPath();b.arc(n/2,u/2,m*l,e,e+r,!1);b.arc(n/2,u/2,m*h,e+r,e,!0);b.closePath();b.fillStyle=a[g].color;b.fill();if(0.9999999<f){var k=[];k.push({x:n/2+l*Math.cos(e),y:u/2+l*Math.sin(e)});for(var q=0;50>=q;q++)k.push({x:n/2+l*Math.cos(e+q/50*r),y:u/2+l*Math.sin(e+q/50*r)});k.push({x:n/2+h*Math.cos(e+r),y:u/2+h*Math.sin(e+r)});for(q=50;0<=q;q--)k.push({x:n/2+h*Math.cos(e+q/50*r),y:u/2+h*Math.sin(e+q/50*r)});A(b,{type:"shape",points:k},{label:a[g].label,value:a[g].value},"Doughnut")}c.segmentShowStroke&&
(b.lineWidth=c.segmentStrokeWidth,b.strokeStyle=c.segmentStrokeColor,b.stroke());e+=r}},b)},S=function(a,c,b){var d,l,h,m,f,e,s,p,g,w,k,q,t=0;(function(){d=u;b.font=c.scaleFontStyle+" "+c.scaleFontSize+"px "+c.scaleFontFamily;g=1;for(var h=0;h<a.labels.length;h++){var k=b.measureText(a.labels[h]).width;g=k>g?k:g}n/a.labels.length<g?(t=45,n/a.labels.length<Math.cos(t)*g?(t=90,d-=g):d-=Math.sin(t)*g):d-=c.scaleFontSize;d-=5;m=c.scaleFontSize;f=d-=m})();e=function(){for(var b=Number.MIN_VALUE,c=Number.MAX_VALUE,
d=0;d<a.datasets.length;d++)for(var g=0;g<a.datasets[d].data.length;g++)a.datasets[d].data[g]>b&&(b=a.datasets[d].data[g]),a.datasets[d].data[g]<c&&(c=a.datasets[d].data[g]);return{maxValue:b,minValue:c,maxSteps:Math.floor(f/(0.66*m)),minSteps:Math.floor(0.5*(f/m))}}();s=c.scaleShowLabels?c.scaleLabel:"";c.scaleOverride?(h={steps:c.scaleSteps,stepValue:c.scaleStepWidth,graphMin:c.scaleStartValue,labels:[]},C(s,h.labels,h.steps,c.scaleStartValue,c.scaleStepWidth)):h=F(f,e.maxSteps,e.minSteps,e.maxValue,
e.minValue,s);l=Math.floor(f/h.steps);(function(){var d=1;if(c.scaleShowLabels){b.font=c.scaleFontStyle+" "+c.scaleFontSize+"px "+c.scaleFontFamily;for(var e=0;e<h.labels.length;e++)var l=b.measureText(h.labels[e]).width,d=l>d?l:d;d+=10}w=n-d-g;p=Math.floor(w/(a.labels.length-1));k=n-g/2-w;q=f+c.scaleFontSize/2})();B(c,function(){b.lineWidth=c.scaleLineWidth;b.strokeStyle=c.scaleLineColor;b.beginPath();b.moveTo(n-g/2+5,q);b.lineTo(n-g/2-w-5,q);b.stroke();0<t?(b.save(),b.textAlign="right"):b.textAlign=
"center";b.fillStyle=c.scaleFontColor;for(var d=0;d<a.labels.length;d++)b.save(),0<t?(b.translate(k+d*p,q+c.scaleFontSize),b.rotate(-(t*(Math.PI/180))),b.fillText(a.labels[d],0,0),b.restore()):b.fillText(a.labels[d],k+d*p,q+c.scaleFontSize+3),b.beginPath(),b.moveTo(k+d*p,q+3),c.scaleShowGridLines&&0<d?(b.lineWidth=c.scaleGridLineWidth,b.strokeStyle=c.scaleGridLineColor,b.lineTo(k+d*p,5)):b.lineTo(k+d*p,q+3),b.stroke();b.lineWidth=c.scaleLineWidth;b.strokeStyle=c.scaleLineColor;b.beginPath();b.moveTo(k,
q+5);b.lineTo(k,5);b.stroke();b.textAlign="right";b.textBaseline="middle";for(d=0;d<h.steps;d++)b.beginPath(),b.moveTo(k-3,q-(d+1)*l),c.scaleShowGridLines?(b.lineWidth=c.scaleGridLineWidth,b.strokeStyle=c.scaleGridLineColor,b.lineTo(k+w+5,q-(d+1)*l)):b.lineTo(k-0.5,q-(d+1)*l),b.stroke(),c.scaleShowLabels&&b.fillText(h.labels[d],k-8,q-(d+1)*l)},function(d){function g(b,c){return q-d*y(a.datasets[b].data[c],h,l)}for(var f=0;f<a.datasets.length;f++){b.strokeStyle=a.datasets[f].strokeColor;b.lineWidth=
c.datasetStrokeWidth;b.beginPath();b.moveTo(k,q-d*y(a.datasets[f].data[0],h,l));for(var e=1;e<a.datasets[f].data.length;e++)c.bezierCurve?b.bezierCurveTo(k+p*(e-0.5),g(f,e-1),k+p*(e-0.5),g(f,e),k+p*e,g(f,e)):b.lineTo(k+p*e,g(f,e));for(var m=c.pointDot?c.pointDotRadius+c.pointDotStrokeWidth:10,e=0;e<a.datasets[f].data.length;e++)1==d&&A(b,{type:"circle",x:k+p*e,y:g(f,e),r:m},{label:a.labels[e],value:a.datasets[f].data[e]},"Line");b.stroke();c.datasetFill?(b.lineTo(k+p*(a.datasets[f].data.length-1),
q),b.lineTo(k,q),b.closePath(),b.fillStyle=a.datasets[f].fillColor,b.fill()):b.closePath();if(c.pointDot){b.fillStyle=a.datasets[f].pointColor;b.strokeStyle=a.datasets[f].pointStrokeColor;b.lineWidth=c.pointDotStrokeWidth;for(e=0;e<a.datasets[f].data.length;e++)b.beginPath(),b.arc(k+p*e,q-d*y(a.datasets[f].data[e],h,l),c.pointDotRadius,0,2*Math.PI,!0),b.fill(),b.stroke()}}},b)},T=function(a,c,b){var d,l,h,m,f,e,s,p,g,w,k,q,t,v=0;(function(){d=u;b.font=c.scaleFontStyle+" "+c.scaleFontSize+"px "+c.scaleFontFamily;
g=1;for(var e=0;e<a.labels.length;e++){var h=b.measureText(a.labels[e]).width;g=h>g?h:g}n/a.labels.length<g?(v=45,n/a.labels.length<Math.cos(v)*g?(v=90,d-=g):d-=Math.sin(v)*g):d-=c.scaleFontSize;d-=5;m=c.scaleFontSize;f=d-=m})();e=function(){for(var b=Number.MIN_VALUE,c=Number.MAX_VALUE,d=0;d<a.datasets.length;d++)for(var e=0;e<a.datasets[d].data.length;e++)a.datasets[d].data[e]>b&&(b=a.datasets[d].data[e]),a.datasets[d].data[e]<c&&(c=a.datasets[d].data[e]);return{maxValue:b,minValue:c,maxSteps:Math.floor(f/
(0.66*m)),minSteps:Math.floor(0.5*(f/m))}}();s=c.scaleShowLabels?c.scaleLabel:"";c.scaleOverride?(h={steps:c.scaleSteps,stepValue:c.scaleStepWidth,graphMin:c.scaleStartValue,labels:[]},C(s,h.labels,h.steps,c.scaleStartValue,c.scaleStepWidth)):h=F(f,e.maxSteps,e.minSteps,e.maxValue,e.minValue,s);l=Math.floor(f/h.steps);(function(){var d=1;if(c.scaleShowLabels){b.font=c.scaleFontStyle+" "+c.scaleFontSize+"px "+c.scaleFontFamily;for(var e=0;e<h.labels.length;e++)var l=b.measureText(h.labels[e]).width,
d=l>d?l:d;d+=10}w=n-d-g;p=Math.floor(w/a.labels.length);t=(p-2*c.scaleGridLineWidth-2*c.barValueSpacing-(c.barDatasetSpacing*a.datasets.length-1)-(c.barStrokeWidth/2*a.datasets.length-1))/a.datasets.length;k=n-g/2-w;q=f+c.scaleFontSize/2})();B(c,function(){b.lineWidth=c.scaleLineWidth;b.strokeStyle=c.scaleLineColor;b.beginPath();b.moveTo(n-g/2+5,q);b.lineTo(n-g/2-w-5,q);b.stroke();0<v?(b.save(),b.textAlign="right"):b.textAlign="center";b.fillStyle=c.scaleFontColor;for(var d=0;d<a.labels.length;d++)b.save(),
0<v?(b.translate(k+d*p,q+c.scaleFontSize),b.rotate(-(v*(Math.PI/180))),b.fillText(a.labels[d],0,0),b.restore()):b.fillText(a.labels[d],k+d*p+p/2,q+c.scaleFontSize+3),b.beginPath(),b.moveTo(k+(d+1)*p,q+3),b.lineWidth=c.scaleGridLineWidth,b.strokeStyle=c.scaleGridLineColor,b.lineTo(k+(d+1)*p,5),b.stroke();b.lineWidth=c.scaleLineWidth;b.strokeStyle=c.scaleLineColor;b.beginPath();b.moveTo(k,q+5);b.lineTo(k,5);b.stroke();b.textAlign="right";b.textBaseline="middle";for(d=0;d<h.steps;d++)b.beginPath(),b.moveTo(k-
3,q-(d+1)*l),c.scaleShowGridLines?(b.lineWidth=c.scaleGridLineWidth,b.strokeStyle=c.scaleGridLineColor,b.lineTo(k+w+5,q-(d+1)*l)):b.lineTo(k-0.5,q-(d+1)*l),b.stroke(),c.scaleShowLabels&&b.fillText(h.labels[d],k-8,q-(d+1)*l)},function(d){b.lineWidth=c.barStrokeWidth;for(var e=0;e<a.datasets.length;e++){b.fillStyle=a.datasets[e].fillColor;b.strokeStyle=a.datasets[e].strokeColor;for(var f=0;f<a.datasets[e].data.length;f++){var g=k+c.barValueSpacing+p*f+t*e+c.barDatasetSpacing*e+c.barStrokeWidth*e;b.beginPath();
b.moveTo(g,q);b.lineTo(g,q-d*y(a.datasets[e].data[f],h,l)+c.barStrokeWidth/2);b.lineTo(g+t,q-d*y(a.datasets[e].data[f],h,l)+c.barStrokeWidth/2);b.lineTo(g+t,q);c.barShowStroke&&b.stroke();b.closePath();b.fill();if(1==d){var m=y(a.datasets[e].data[f],h,l);A(b,{type:"rect",x:g,y:q-m,width:t,height:m},{label:a.labels[f],value:a.datasets[e].data[f]},"Bar")}}}},b)},K=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||
window.msRequestAnimationFrame||function(a){window.setTimeout(a,1E3/60)}}(),L={}};
