...
l=Math.cos(e*g)*(d+c.pointLabelFontSize);b.textAlign=e*g==Math.PI||0==e*g?"center":e*g>Math.PI?"right":"left";b.textBaseline="middle";b.fillText(a.labels[g],s,-l)}b.restore()},function(d){var g=2*Math.PI/a.datasets[0].data.length;b.save();b.translate(n/2,u/2);for(var e=0;e<a.datasets.length;e++){var l=x(a.datasets[e].data[0],f,h);b.beginPath();b.moveTo(0,d*-1*l);if(1==d){var m=n/2+l*Math.cos(0-Math.PI/2),l=u/2+l*Math.sin(0-Math.PI/2),k=c.pointDot?c.pointDotRadius+c.pointDotStrokeWidth:10;a.labels[0].trim();
z(b,{type:"circle",x:m,y:l,r:k},{label:a.labels[0],value:a.datasets[e].data[0]},"Radar")}for(var w=1;w<a.datasets[e].data.length;w++)l=x(a.datasets[e].data[w],f,h),b.rotate(g),b.lineTo(0,d*-1*l),1==d&&(m=n/2+l*Math.cos(w*g-Math.PI/2),l=u/2+l*Math.sin(w*g-Math.PI/2),k=c.pointDot?c.pointDotRadius+c.pointDotStrokeWidth:10,a.labels[w].trim(),z(b,{type:"circle",x:m,y:l,r:k},{label:a.labels[w],value:a.datasets[e].data[w]},"Radar"));b.closePath();b.fillStyle=a.datasets[e].fillColor;b.strokeStyle=a.datasets[e].strokeColor;
b.lineWidth=c.datasetStrokeWidth;b.fill();b.stroke();if(c.pointDot){b.fillStyle=a.datasets[e].pointColor;b.strokeStyle=a.datasets[e].pointStrokeColor;b.lineWidth=c.pointDotStrokeWidth;for(m=0;m<a.datasets[e].data.length;m++)b.rotate(g),b.beginPath(),b.arc(0,d*-1*x(a.datasets[e].data[m],f,h),c.pointDotRadius,2*Math.PI,!1),b.fill(),b.stroke()}b.rotate(g)}b.restore()},b)},P=function(a,c,b){for(var d=0,h=Math.min.apply(Math,[u/2,n/2])-5,f=0;f<a.length;f++)d+=a[f].value;b.fillStyle="black";b.textBaseline=
"base";A(c,null,function(f){var k=-Math.PI/2,e=1,q=1;c.animation&&(c.animateScale&&(e=f),c.animateRotate&&(q=f));for(var r=0;r<a.length;r++){var g=q*a[r].value/d*2*Math.PI;b.beginPath();b.arc(n/2,u/2,e*h,k,k+g);b.lineTo(n/2,u/2);b.closePath();b.fillStyle=a[r].color;b.fill();if(a[r].label&&2*(e*h)*g/(2*Math.PI)>c.labelFontSize){var s=function(a){switch(a){case "left":return"right";case "right":return"left";case "center":return a}},l=a[r].labelFontSize||c.labelFontSize+"px";null!=l.match(/^[0-9]+$/g)&&
(l+="px");b.font=c.labelFontStyle+" "+l+" "+c.labelFontFamily;b.fillStyle=M(f,a[r].labelColor||"black",a[r].color);b.textBaseline="middle";var l=-(k+g)+g/2,m=n/2+e*h*Math.cos(l),t=u/2-e*h*Math.sin(l);b.textAlign=a[r].labelAlign||c.labelAlign;textX=function(a,b){switch(a){case "left":return-b+20;case "center":return-b/2}return-10}(b.textAlign,e*h);l<-Math.PI/2&&(l-=Math.PI,b.textAlign=s(b.textAlign),textX=-textX);b.translate(m,t);b.rotate(-l);b.fillText(a[r].label,textX,0);b.rotate(l);b.translate(-m,
-t)}if(0.9999999<f){s=[{x:n/2,y:u/2}];s.push({x:n/2+h*Math.cos(k),y:u/2+h*Math.sin(k)});for(l=0;50>=l;l++)s.push({x:n/2+h*Math.cos(k+l/50*g),y:u/2+h*Math.sin(k+l/50*g)});z(b,{type:"shape",points:s},{label:a[r].label,value:a[r].value},"Pie")}c.segmentShowStroke&&(b.lineWidth=c.segmentStrokeWidth,b.strokeStyle=c.segmentStrokeColor,b.stroke());k+=g}},b)},Q=function(a,c,b){for(var d=0,h=Math.min.apply(Math,[u/2,n/2])-5,f=h*(c.percentageInnerCutout/100),p=0;p<a.length;p++)d+=a[p].value;A(c,null,function(k){var e=
-Math.PI/2,p=1,r=1;c.animation&&(c.animateScale&&(p=k),c.animateRotate&&(r=k));for(var g=0;g<a.length;g++){var s=r*a[g].value/d*2*Math.PI;b.beginPath();b.arc(n/2,u/2,p*h,e,e+s,!1);b.arc(n/2,u/2,p*f,e+s,e,!0);b.closePath();b.fillStyle=a[g].color;b.fill();if(0.9999999<k){var l=[];l.push({x:n/2+h*Math.cos(e),y:u/2+h*Math.sin(e)});for(var m=0;50>=m;m++)l.push({x:n/2+h*Math.cos(e+m/50*s),y:u/2+h*Math.sin(e+m/50*s)});l.push({x:n/2+f*Math.cos(e+s),y:u/2+f*Math.sin(e+s)});for(m=50;0<=m;m--)l.push({x:n/2+
f*Math.cos(e+m/50*s),y:u/2+f*Math.sin(e+m/50*s)});z(b,{type:"shape",points:l},{label:a[g].label,value:a[g].value},"Doughnut")}c.segmentShowStroke&&(b.lineWidth=c.segmentStrokeWidth,b.strokeStyle=c.segmentStrokeColor,b.stroke());e+=s}},b)},R=function(a,c,b){var d,h,f,p,k,e,q,r,g,s,l,m,t=0;(function(){d=u;b.font=c.scaleFontStyle+" "+c.scaleFontSize+"px "+c.scaleFontFamily;g=1;for(var f=0;f<a.labels.length;f++){var e=b.measureText(a.labels[f]).width;g=e>g?e:g}n/a.labels.length<g?(t=45,n/a.labels.length<
Math.cos(t)*g?(t=90,d-=g):d-=Math.sin(t)*g):d-=c.scaleFontSize;d-=5;p=c.scaleFontSize;k=d-=p})();e=function(){for(var b=Number.MIN_VALUE,c=Number.MAX_VALUE,d=0;d<a.datasets.length;d++)for(var f=0;f<a.datasets[d].data.length;f++)a.datasets[d].data[f]>b&&(b=a.datasets[d].data[f]),a.datasets[d].data[f]<c&&(c=a.datasets[d].data[f]);return{maxValue:b,minValue:c,maxSteps:Math.floor(k/(0.66*p)),minSteps:Math.floor(0.5*(k/p))}}();q=c.scaleShowLabels?c.scaleLabel:"";c.scaleOverride?(f={steps:c.scaleSteps,
stepValue:c.scaleStepWidth,graphMin:c.scaleStartValue,labels:[]},B(q,f.labels,f.steps,c.scaleStartValue,c.scaleStepWidth)):f=E(k,e.maxSteps,e.minSteps,e.maxValue,e.minValue,q);h=Math.floor(k/f.steps);(function(){var d=1;if(c.scaleShowLabels){b.font=c.scaleFontStyle+" "+c.scaleFontSize+"px "+c.scaleFontFamily;for(var e=0;e<f.labels.length;e++)var h=b.measureText(f.labels[e]).width,d=h>d?h:d;d+=10}s=n-d-g;r=Math.floor(s/(a.labels.length-1));l=n-g/2-s;m=k+c.scaleFontSize/2})();A(c,function(){b.lineWidth=
c.scaleLineWidth;b.strokeStyle=c.scaleLineColor;b.beginPath();b.moveTo(n-g/2+5,m);b.lineTo(n-g/2-s-5,m);b.stroke();0<t?(b.save(),b.textAlign="right"):b.textAlign="center";b.fillStyle=c.scaleFontColor;for(var d=0;d<a.labels.length;d++)b.save(),0<t?(b.translate(l+d*r,m+c.scaleFontSize),b.rotate(-(t*(Math.PI/180))),b.fillText(a.labels[d],0,0),b.restore()):b.fillText(a.labels[d],l+d*r,m+c.scaleFontSize+3),b.beginPath(),b.moveTo(l+d*r,m+3),c.scaleShowGridLines&&0<d?(b.lineWidth=c.scaleGridLineWidth,b.strokeStyle=
c.scaleGridLineColor,b.lineTo(l+d*r,5)):b.lineTo(l+d*r,m+3),b.stroke();b.lineWidth=c.scaleLineWidth;b.strokeStyle=c.scaleLineColor;b.beginPath();b.moveTo(l,m+5);b.lineTo(l,5);b.stroke();b.textAlign="right";b.textBaseline="middle";for(d=0;d<f.steps;d++)b.beginPath(),b.moveTo(l-3,m-(d+1)*h),c.scaleShowGridLines?(b.lineWidth=c.scaleGridLineWidth,b.strokeStyle=c.scaleGridLineColor,b.lineTo(l+s+5,m-(d+1)*h)):b.lineTo(l-0.5,m-(d+1)*h),b.stroke(),c.scaleShowLabels&&b.fillText(f.labels[d],l-8,m-(d+1)*h)},
function(d){function e(b,c){return m-d*x(a.datasets[b].data[c],f,h)}for(var g=0;g<a.datasets.length;g++){b.strokeStyle=a.datasets[g].strokeColor;b.lineWidth=c.datasetStrokeWidth;b.beginPath();b.moveTo(l,m-d*x(a.datasets[g].data[0],f,h));for(var k=1;k<a.datasets[g].data.length;k++)c.bezierCurve?b.bezierCurveTo(l+r*(k-0.5),e(g,k-1),l+r*(k-0.5),e(g,k),l+r*k,e(g,k)):b.lineTo(l+r*k,e(g,k));for(var n=c.pointDot?c.pointDotRadius+c.pointDotStrokeWidth:10,k=0;k<a.datasets[g].data.length;k++)1==d&&z(b,{type:"circle",
x:l+r*k,y:e(g,k),r:n},{label:a.labels[k],value:a.datasets[g].data[k]},"Line");b.stroke();c.datasetFill?(b.lineTo(l+r*(a.datasets[g].data.length-1),m),b.lineTo(l,m),b.closePath(),b.fillStyle=a.datasets[g].fillColor,b.fill()):b.closePath();if(c.pointDot){b.fillStyle=a.datasets[g].pointColor;b.strokeStyle=a.datasets[g].pointStrokeColor;b.lineWidth=c.pointDotStrokeWidth;for(k=0;k<a.datasets[g].data.length;k++)b.beginPath(),b.arc(l+r*k,m-d*x(a.datasets[g].data[k],f,h),c.pointDotRadius,0,2*Math.PI,!0),
b.fill(),b.stroke()}}},b)},S=function(a,c,b){var d,h,f,p,k,e,q,r,g,s,l,m,t,v=0;(function(){d=u;b.font=c.scaleFontStyle+" "+c.scaleFontSize+"px "+c.scaleFontFamily;g=1;for(var f=0;f<a.labels.length;f++){var e=b.measureText(a.labels[f]).width;g=e>g?e:g}n/a.labels.length<g?(v=45,n/a.labels.length<Math.cos(v)*g?(v=90,d-=g):d-=Math.sin(v)*g):d-=c.scaleFontSize;d-=5;p=c.scaleFontSize;k=d-=p})();e=function(){for(var b=Number.MIN_VALUE,c=Number.MAX_VALUE,d=0;d<a.datasets.length;d++)for(var f=0;f<a.datasets[d].data.length;f++)a.datasets[d].data[f]>
...
" "+c.scaleFontSize+"px "+c.scaleFontFamily;for(var e=0;e<f.labels.length;e++)var h=b.measureText(f.labels[e]).width,d=h>d?h:d;d+=10}s=n-d-g;r=Math.floor(s/a.labels.length);t=(r-2*c.scaleGridLineWidth-2*c.barValueSpacing-(c.barDatasetSpacing*a.datasets.length-1)-(c.barStrokeWidth/2*a.datasets.length-1))/a.datasets.length;l=n-g/2-s;m=k+c.scaleFontSize/2})();A(c,function(){b.lineWidth=c.scaleLineWidth;b.strokeStyle=c.scaleLineColor;b.beginPath();b.moveTo(n-g/2+5,m);b.lineTo(n-g/2-s-5,m);b.stroke();
0<v?(b.save(),b.textAlign="right"):b.textAlign="center";b.fillStyle=c.scaleFontColor;for(var d=0;d<a.labels.length;d++)b.save(),0<v?(b.translate(l+d*r,m+c.scaleFontSize),b.rotate(-(v*(Math.PI/180))),b.fillText(a.labels[d],0,0),b.restore()):b.fillText(a.labels[d],l+d*r+r/2,m+c.scaleFontSize+3),b.beginPath(),b.moveTo(l+(d+1)*r,m+3),b.lineWidth=c.scaleGridLineWidth,b.strokeStyle=c.scaleGridLineColor,b.lineTo(l+(d+1)*r,5),b.stroke();b.lineWidth=c.scaleLineWidth;b.strokeStyle=c.scaleLineColor;b.beginPath();
b.moveTo(l,m+5);b.lineTo(l,5);b.stroke();b.textAlign="right";b.textBaseline="middle";for(d=0;d<f.steps;d++)b.beginPath(),b.moveTo(l-3,m-(d+1)*h),c.scaleShowGridLines?(b.lineWidth=c.scaleGridLineWidth,b.strokeStyle=c.scaleGridLineColor,b.lineTo(l+s+5,m-(d+1)*h)):b.lineTo(l-0.5,m-(d+1)*h),b.stroke(),c.scaleShowLabels&&b.fillText(f.labels[d],l-8,m-(d+1)*h)},function(d){b.lineWidth=c.barStrokeWidth;for(var e=0;e<a.datasets.length;e++){b.fillStyle=a.datasets[e].fillColor;b.strokeStyle=a.datasets[e].strokeColor;
for(var g=0;g<a.datasets[e].data.length;g++){var k=l+c.barValueSpacing+r*g+t*e+c.barDatasetSpacing*e+c.barStrokeWidth*e;b.beginPath();b.moveTo(k,m);b.lineTo(k,m-d*x(a.datasets[e].data[g],f,h)+c.barStrokeWidth/2);b.lineTo(k+t,m-d*x(a.datasets[e].data[g],f,h)+c.barStrokeWidth/2);b.lineTo(k+t,m);c.barShowStroke&&b.stroke();b.closePath();b.fill();if(1==d){var n=x(a.datasets[e].data[g],f,h);z(b,{type:"rect",x:k,y:m-n,width:t,height:n},{label:a.labels[g],value:a.datasets[e].data[g]},"Bar")}}}},b)},J=function(){return window.requestAnimationFrame||
window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(a){window.setTimeout(a,1E3/60)}}(),K={}};
