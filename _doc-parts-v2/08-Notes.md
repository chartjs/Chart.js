...
### Browser support
Browser support for the canvas element is available in all modern & major mobile browsers [(canisue.com/canvas)](http://caniuse.com/canvas).

For IE8 & below, I would recommend using the polyfill ExplorerCanvas - available at [https://code.google.com/p/explorercanvas/](https://code.google.com/p/explorercanvas/). It falls back to Internet explorer's format VML when canvas support is not available. Example use:
...
Please report these on the GitHub page - at [github.com/nnnick/Chart.js](http://github.com/nnnick/Chart.js). If you could include a link to a simple [jsbin](http://jsbin.com/) or similar to demonstrate the issue, that'd be really helpful.
