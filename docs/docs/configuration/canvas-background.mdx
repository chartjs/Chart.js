...
In the two examples underneath here you can see how you can make the background a color or an image. This way of giving the chart a background is only necessary if you want to export the chart with that specific background.
