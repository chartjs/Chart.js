...
function blitText(text, x, y) {
	if (text && text.charCodeAt) {
		...
		for (let i = 0; i < text.length; ++i) {
			...
			this.drawImage(bmp, sx, sy, w, h, x, y, w, h);
			x += w;
		}
	}
}
