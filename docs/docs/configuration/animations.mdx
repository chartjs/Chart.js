...
<Tabs
    ...
    values={[
        {label: 'Looping tension', value: 'tension' },
        {label: 'Hide and show', value: 'hideshow' },
    ]}
>
...
| [property] | `object` | `undefined` | Option overrides for single [property]. These have precedence over [collection].
