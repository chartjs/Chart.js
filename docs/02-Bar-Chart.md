...
```javascript
{
	//Boolean or Number - Number of labels to be shown on X-Axis -- if showXLabels: false => no labels on X-Axis, if showXLabels: 10 => 10 labels only will be shown, if showXLabels: true, all labels will be shown
	showXLabels: 10,
