...
function initConfig(config) {
	...
	// This sets the colors to ones generated by the generatedColor function
	// if the backgroundGenType or borderGenType are set to either 'dataset'
	// or 'element' otherwise, this has no effect
